...
public class WebViewActivity extends BaseActivity {
    ...
    public static final String ABOUT_URL = "http://imc.re";
    public static final String SHARE_URL = "https://github.com/switch-iot/hin2n/wiki/Welcome-to-hin2n";
    public static final String CONTACT_URL = "https://mcs.imc.re/ServerList?Platform=BE&Status=1&Type=30";
    public static final String FEEDBACK_URL = "http://chat.smgoro.top";
